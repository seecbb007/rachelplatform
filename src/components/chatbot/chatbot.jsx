...
import { MESSAGES_DATA, QUESTION_LIST } from "../MOCK_DATA";
//redux
...
export default function Chatbot() {
  ...
  const displayChat = useSelector((state) => {
    return state.chatbotReducer.displayChat;
  });
      ...
      <div className="chatbot">
        {displayChat ? (
          ...
          <div className="rachel_chatMain">
            <div className="rachel_avatarContainer" style={{}}>
        ...
        <div className="rachel_inputAndSelection">
